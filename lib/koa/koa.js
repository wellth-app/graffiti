...
function middleware() {
  ...
  var _ref$graphiqlPath = _ref.graphiqlPath;
  var graphiqlPath = _ref$graphiqlPath === undefined ? null : _ref$graphiqlPath;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(this.path === graphiqlPath && (0, _util.isGet)(this))) {
              _context.next = 10;
              break;
            }
